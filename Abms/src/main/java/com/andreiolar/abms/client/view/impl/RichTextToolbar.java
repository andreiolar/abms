...
/**
 * A sample toolbar for use with {@link RichTextArea}. It provides a simple UI for all rich text formatting, dynamically displayed only for the
...
public class RichTextToolbar extends Composite {
	...
	/**
	 * This {@link ClientBundle} is used for all the button icons. Using a bundle allows all of these images to be packed into a single image, which
